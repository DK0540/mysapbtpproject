		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Wizard App",
									"targetURL": "#comexamplewizardapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplewizardapp-display": {
								"semanticObject": "comexamplewizardapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.wizardapp",
									"url": sap.ui.require.toUrl("com/example/wizardapp")
								}
							}
						}
					}
